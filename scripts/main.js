...
function helloWorld() {
    const a = 'Hello World!';
    document.write('Question 1. ' + (a) + '<br>');
    console.log(a);
}
helloWorld();
...
document.write(' Question 2. ' + greeting('Danny') + '<br>');
...
document.write(' Question 3. ' + divisibleByThree(9) + '<br>');
...
document.write(' Question 4. ' + averageAge(4,9) + '<br>');
console.log(averageAge(4,8,19));
...
document.write(' Question 5. ' + leetSpeak('leet') + '<br>');
